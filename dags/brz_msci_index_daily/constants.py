...
MSCI_INDEX_TMP_FILE_PATH = "/tmp/msci_index_{{ macros.ds_add(ds, -1) }}.json"
# MSCI index 데이터 수집 데이터 파일 S3 키
MSCI_INDEX_DATA_S3_KEY = "bronze/msci_index/ymd={{ macros.ds_add(ds, -1) }}/{{ macros.ds_add(ds, -1) }}_msci_index.json"
